    ...
    return (
        <>
            ...
            <div className="mt8p">
                ...
                <Input placeholder="Enter Email" onChange={handleChange} name="email" value={data.email} style={{height: 39}} />

                <div className="input-lable mt20">Password</div>
                <Input type="password" placeholder="Enter Password" onChange={handleChange} name="password1" value={data.password1} style={{height: 39}} />

                <div className="input-lable mt20">Confirm Password</div>
                <Input type="password" placeholder="Enter Password Again" onChange={handleChange} name="password2" value={data.password2} style={{height: 39}}/>
            </div>
