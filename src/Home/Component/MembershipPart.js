...
const MembershipPart = (props) => {
  ...
  const dateFullCellRender = (value) => {
    const isCurrentMonth =
      value.month() === currentView.month && value.year() === currentView.year;
    ...
    return (
      <div className="centerize-flex">
        <div className={cellClassName} onClick={onPanelChange}>
          {value.date()}
        </div>
      </div>
    );
    ...
    <div
      className={
        providersToDisplay && providersToDisplay.length > 0
          ? "mb5p sticky-appointment-card sticky-appointment-card-provider "
          : "mb5p sticky-appointment-card"
      }
    >
      <Col span={24}>
        <div style={{ background: "#FFF" }}>
          ...
          <Row style={{ background: "#FFF" }}>
            <span className="profile-clinic-section-subtitle">
              Choose the service you want, then find the desired day from the
              calendar.
            </span>
          </Row>
          <div className="_mubbvpq">
            {bookingStep == 1 ? (
              <div className="card-membership">
                <Row type="flex" justify="space-between">
                  <span style={{ fontWeight: "bold", marginBottom: "28px" }}>
              ...
              <div className="card-membership">
                <Row type="flex" justify="center">
                  ...
                  <div className="success-message-appointment">
                    Your dental appointment information has been sent to your
                    email.
                  </div>
