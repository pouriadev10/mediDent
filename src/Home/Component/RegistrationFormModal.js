...
const RegistrationForm = (props) => {
    const [form] = Form.useForm(); // use the useForm hook to get form methods
    ...
    return (
        ...
        >
            <Form.Item label="Email" className='form-register-modal'>
            ...
            <Form.Item label="First Name" className='form-register-modal'>
            ...
            <Form.Item label="Last Name" className='form-register-modal'>
            ...
            <Form.Item label="Birth Day" className='form-register-modal'>
            ...
            <Form.Item label="Phone Number" className='form-register-modal'>
            ...
            <Row type="flex" justify="end">
                <Form.Item className='form-register-modal'>
